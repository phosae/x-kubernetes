...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.Foo":     schema_pkg_apis_sample_v1_Foo(ref),
		"github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.FooList": schema_pkg_apis_sample_v1_FooList(ref),
		"github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.FooSpec": schema_pkg_apis_sample_v1_FooSpec(ref),
...
func schema_pkg_apis_sample_v1_Foo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Foo is a demo type integrated into apiserver runtime framework.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.FooSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.FooSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_sample_v1_FooList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FooList is a list of Foo objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.Foo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/phosae/x-kubernetes/api-aggregation-runtime/pkg/apis/sample/v1.Foo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_sample_v1_FooSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"msg": {
						SchemaProps: spec.SchemaProps{
							Description: "Msg persist things like `hello world`",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
