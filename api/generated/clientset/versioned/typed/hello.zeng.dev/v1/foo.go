...
type FooInterface interface {
	...
	Apply(ctx context.Context, foo *hellozengdevv1.FooApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Foo, err error)
	FooExpansion
}
...
func (c *foos) Apply(ctx context.Context, foo *hellozengdevv1.FooApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Foo, err error) {
	if foo == nil {
