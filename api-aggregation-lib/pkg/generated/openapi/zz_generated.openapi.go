...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.Foo":     schema_pkg_apis_foo_v1_Foo(ref),
		"github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.FooList": schema_pkg_apis_foo_v1_FooList(ref),
		"github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.FooSpec": schema_pkg_apis_foo_v1_FooSpec(ref),
...
func schema_pkg_apis_foo_v1_Foo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.FooSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.FooSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_foo_v1_FooList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.Foo"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/phosae/x-kubernetes/api-aggregation-lib/pkg/apis/foo/v1.Foo", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_foo_v1_FooSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
